/*
 * LumetriColor — Premiere Pro–style unified color grading effect.
 *
...
class LumetriColor : public Effect
{
public:
    LumetriColor();
    ~LumetriColor() override = default;
    ...
    // and must match the order expected by lumetri_color.comp push constants.
    enum Param : size_t {
