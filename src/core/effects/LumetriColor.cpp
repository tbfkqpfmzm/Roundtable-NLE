/*
 * LumetriColor.cpp — Unified color grading effect implementation.
 */
...
LumetriColor::LumetriColor()
    : Effect(EffectType::LumetriColor)
{
...
std::unique_ptr<Effect> LumetriColor::clone() const
{
    auto copy = std::make_unique<LumetriColor>();
...
void LumetriColor::resetCurveLUTs()
{
...
std::vector<float> LumetriColor::evalAllParamsWithFlags(int64_t time) const
{
...
std::vector<float> LumetriColor::evalGpuParams(int64_t time) const
{
